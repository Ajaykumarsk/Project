# Generated by Django 5.0.3 on 2024-07-29 07:12
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='CanteenFoodConsummationTiming',
            fields=[
        ...
        migrations.CreateModel(
            name='Visitor',
            fields=[
                ('visitor_pass_no', models.AutoField(primary_key=True, serialize=False)),
                ...
                ('select_employee', models.CharField(max_length=100, null=True)),
                ('host_department', models.CharField(max_length=100, null=True)),
                ('host_email_id', models.EmailField(max_length=254, null=True)),
                ...
                ('visitor_photo', models.ImageField(null=True, upload_to='visitor_photos/')),
                ('id_proof_photo', models.ImageField(null=True, upload_to='id_proof_photos/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Admin'), ('security', 'Security'), ('front_office', 'Front Office')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employee_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='users.employeetype')),
